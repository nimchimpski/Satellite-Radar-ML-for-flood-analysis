...
def reproject_to_epsg4326(tile_path):
    ...
    with rasterio.open(tile_path) as src:
        ...
        output_file = tile_path.with_name(f"4326_{tile_path.name}")
        ...
        return output_file  # Return the path of the reprojected file                                                                                                                                                                                                                                                                                   

def terrasarx_reproject(src, output_path=None):
