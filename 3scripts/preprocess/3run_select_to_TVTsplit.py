...
import sys
import os
from process_tiles_module import process_tiles_newdir, train_split_folder
...
def main():
    ...
    for folder in  tqdm(recursive_list, desc="Processing folders"):
        ...
        # FILTER AND SPLIT
        select_tiles_and_split(folder, dest_dir, train_ratio=0.7, val_ratio=0.15, test_ratio=0.15)
