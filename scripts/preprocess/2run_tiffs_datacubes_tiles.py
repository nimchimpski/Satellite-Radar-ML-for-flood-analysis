...
from scripts.modules.process_tiles_module import tile_datacube
...
def main():
    ...
    for cube in tqdm(cubes, desc="### Datacubes tiled"):
        ...
        num_tiles, num_saved, num_has_nans, num_novalid_layer, num_novalid_pixels, num_nomask, num_nomask_pixels = tile_datacube(cube, save_tiles_path, tile_size=256, stride=256)
