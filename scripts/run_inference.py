...
############################################################################
img_src =  Path(r"C:\Users\floodai\UNOSAT_FloodAI_v2\predictions")
min_max_file = img_src / 'TSX_process1_stats.csv'
norm_func = 'logclipmm_g' # 'mm' or 'logclipmm'
stats = None
ckpt = Path(r"C:\Users\floodai\UNOSAT_FloodAI_v2\4results\checkpoints\TSX_logclipmm_g_mt0.3__BS16__EP10_WEIGHTED_BCE.ckpt")
