...
import torch.nn.functional as F  # Import the functional API from torch.nn
# If using PyTorch >= 1.10.0, use the built-in one_hot function
from torch.nn.functional import one_hot  # For one-hot encoding
