...
def filter_noanalysis(tile):
    # if 1 in tile.sel(band='analysis_extent').values:
    #     return True
    # else:
    #     return False  # If both conditions pass
...
if __name__ == "__main__":
    ...
    for event in tqdm(events):
        ...
        if band_size == 1:
            ...
            # da_rtc = xr.DataArray([rtc_array, rtc_array], dims=['band', 'y', 'x'], coords={'band':['vv', 'vh'], 'y': da_rtc_origin['y'], 'x':da_rtc_origin['x']})
            ...
            # da_rtc = xr.DataArray([rtc_array[0], rtc_array[1]], dims=['band', 'y', 'x'], coords={'band':['vv', 'vh'], 'y': da_rtc_origin['y'], 'x':da_rtc_origin['x']})
            pixels.append(da_rtc)
        ...
        # VV, VH, GRD, DEM, SLOPE, MASK, ANALYSIS EXTENT
